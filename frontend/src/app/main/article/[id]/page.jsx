            ...
            <div className="container mx-auto px-6 py-6">
              ...
              <div className="mb-12 rounded-lg border bg-gray-50 p-6">
                ...
                <p className="mt-4 text-gray-700">
                  Jessica specializes in creating engaging technical content
                  that bridges the gap between developers and users. With over 5
                  years of experience in developer relations, she brings a
                  unique perspective to technical communication.
                </p>
                <div className="mt-4">
                  <Button
                    variant="outline"
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-gray-700">
                          ...
                          creating developer-focused content and your insights
                          are exactly what I needed. The rap video was both
